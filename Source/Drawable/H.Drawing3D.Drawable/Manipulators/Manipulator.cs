...
namespace H.Drawing3D.Drawable.Manipulators
{
    ...
    ///   Provides an abstract base class for manipulators.
    /// </summary>
    public abstract class Manipulator : UIElement3D, IManipulator
    {
        /// <summary>
        ...
        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register(
            ...
            typeof(double),
            typeof(Manipulator),
            new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, (s, e) => ((Manipulator)s).OnValueChanged(e)));
        ...
        protected Manipulator()
        {
            ...
            _ = BindingOperations.SetBinding(this.Model, GeometryModel3D.MaterialProperty, new Binding("Material") { Source = this });
            _ = BindingOperations.SetBinding(this.Model, GeometryModel3D.BackMaterialProperty, new Binding("BackMaterial") { Source = this });
        ...
        {
            get => (Vector3D)this.GetValue(OffsetProperty);
        ...
        {
            get => (Point3D)this.GetValue(PositionProperty);
        ...
        {
            get => (Transform3D)this.GetValue(TargetTransformProperty);
        ...
        {
            _ = BindingOperations.SetBinding(this, TargetTransformProperty, new Binding("Transform") { Source = source });
            _ = BindingOperations.SetBinding(this, TransformProperty, new Binding("Transform") { Source = source });
        }
        ...
        {
            return this.ParentViewport.UnProject(p, hitPlaneOrigin, hitPlaneNormal);
        }
        ...
        {
            base.OnMouseDown(e);
            this.ParentViewport = this.GetViewport3D();
            this.Camera = this.ParentViewport.Camera as ProjectionCamera;
            ProjectionCamera projectionCamera = this.Camera;
        ...
        {
            this.ValueChanged?.Invoke(this, (double)e.NewValue);
        }
        ...
        {
            Matrix3D mat = this.GetTransform();
            mat.Invert();
            MatrixTransform3D t = new(mat);
        ...
        {
            this.Material = new SolidColorBrush(this.Color).ToMaterial();
