...
namespace H.Drawing3D.Drawable.Manipulators
{
    ...
    public class CombinedManipulator : ModelVisual3D
    {
        ...
        public CombinedManipulator()
        {
            ...
            _ = BindingOperations.SetBinding(this, TransformProperty, new Binding("TargetTransform") { Source = this });
        ...
        {
            get => (bool)this.GetValue(CanRotateXProperty);
        ...
        {
            get => (bool)this.GetValue(CanRotateYProperty);
        ...
        {
            get => (bool)this.GetValue(CanRotateZProperty);
        ...
        {
            get => (bool)this.GetValue(CanTranslateXProperty);
        ...
        {
            get => (bool)this.GetValue(CanTranslateYProperty);
        ...
        {
            get => (bool)this.GetValue(CanTranslateZProperty);
        ...
        {
            get => this.translateXManipulator.Offset;
        ...
        {
            get => this.rotateXManipulator.Pivot;
        ...
        {
            get => this.translateXManipulator.Position;
