...
namespace H.Drawing3D.Drawable.Manipulators
{
    ...
    public class BindableRotateManipulator : Manipulator
    {
        ...
        protected override void PositionChanged(DependencyPropertyChangedEventArgs e)
        {
            ...
            Point3D oldValue = (Point3D)e.OldValue;
            Point3D newValue = (Point3D)e.NewValue;
            Vector3D delta = newValue - oldValue;
            this.Pivot += delta;
        }
        ...
        protected override void OnValueChanged(DependencyPropertyChangedEventArgs e)
        {
            ...
            double theta = newValue - oldValue;
            ...
            {
                RotateTransform3D targetRotateTransform = new(new AxisAngleRotation3D(this.Axis, theta), this.Pivot);
