...
namespace H.Drawing3D.Shape.File.Importers
{
    ...
    public class ObjReader : ModelReader
    {
        ...
        {
            set => this.currentSmoothingGroup = value ? 1 : 0;
        }
        ...
        {
            input = input.Trim();
            string[] fields = input.Split(Delimiters, StringSplitOptions.RemoveEmptyEntries);
        ...
        {
            Group currentGroup = this.CurrentGroup;
            MeshBuilder builder = currentGroup.MeshBuilder;
            Point3DCollection positions = builder.Positions;
            PointCollection textureCoordinates = builder.TextureCoordinates;
            Vector3DCollection normals = builder.Normals;
            ...
            this.Dispatch(() =>
                {
                    ...
                    {
                        foreach (Model3D gm in g.CreateModels())
                        {
                            gm.SetName(g.Name);
