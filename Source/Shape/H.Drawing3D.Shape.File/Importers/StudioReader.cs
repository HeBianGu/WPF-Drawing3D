...
namespace H.Drawing3D.Shape.File.Importers
{
    ...
    public class StudioReader : ModelReader
    {
        ...
        {
            ChunkID type = this.ReadChunkId(reader);
        ...
        {
            _ = this.ReadChunkId(reader);
            _ = this.ReadChunkSize(reader);
            _ = reader.ReadUInt16();
            _ = reader.ReadUInt16();
            _ = reader.ReadUInt16();
            _ = reader.ReadUInt16();
            ...
            while (bytesRead < chunkSize)
            {
                ...
                switch (id)
                {
                    ...
                    case ChunkID.TRI_LOCAL:
                        _ = this.ReadTransformation(reader);
                        break;
