...
namespace H.Drawing3D.View.SelectionCommands
{
    ...
    public class RectangleSelectionCommand : SelectionCommand
    {
        ...
        protected override void Completed(ManipulationEventArgs e)
        {
            ...
            System.Collections.Generic.IEnumerable<Viewport3DHelper.RectangleHitResult> res = this.Viewport.FindHits(this.selectionRect, this.SelectionHitMode);
            ...
            // existing selection.
            if (this.selectionRect.Size.Equals(default) && selectedModels.Any())
            {
                return;
            }
        ...
        private void ShowRectangle()
        {
            ...
            AdornerLayer adornerLayer = AdornerLayer.GetAdornerLayer(this.Viewport);
