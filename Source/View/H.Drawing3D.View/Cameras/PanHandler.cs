...
namespace H.Drawing3D.View.Cameras
{
    ...
    internal class PanHandler : MouseGestureHandler
    {
        ...
        {
            base.Delta(e);
            Point3D? thisPoint3D = this.UnProject(e.CurrentPosition, this.panPoint3D, this.Controller.CameraLookDirection);
        ...
        {
            Point mousePoint = this.LastPoint + delta;

            Point3D? thisPoint3D = this.UnProject(mousePoint, this.panPoint3D, this.Controller.CameraLookDirection);
        ...
        {
            Vector speed = (this.LastPoint - this.MouseDownPoint) * (40.0 / elapsedTime);
